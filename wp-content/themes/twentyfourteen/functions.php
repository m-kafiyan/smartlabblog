...
function twentytwelve_entry_meta() {
	...
	if ( $tag_list ) {
		$utility_text = __( '<ul><li>Category :%1$s | tages : %2$s | on : %3$s | <span class="by-author"> by %4$s</span></li></ul>', 'twentytwelve' );
	} elseif ( $categories_list ) {
		$utility_text = __( '<ul><li>category : %1$s | on : %3$s | <span class="by-author"> by %4$s</span></li></ul>', 'twentytwelve' );
	} else {
		$utility_text = __( '<ul><li>on : %3$s | <span class="by-author"> by %4$s</span></li></ul>', 'twentytwelve' );
	}
